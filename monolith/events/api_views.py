...
import json
from .acl import getCityPhoto, get_weather_data
...
def api_list_locations(request):
    ...
    if request.method == "GET":
        ...
        content = json.loads(request.body)
        content["image_url"] = getCityPhoto(content["city"], content["state"])
        try:
            # changed this query to name= instead of abbreviation=
        ...
        newloc = Location.objects.create(**content)
        return JsonResponse(newloc, encoder=LocationDetailEncoder, safe=False)
